 ...
 * @author semitree
 * @param params
 * params.x : 瑕佹棆杞殑鐐圭殑x鍧愭爣
 * params.y : 瑕佹棆杞殑鐐圭殑y鍧愭爣
 * params.center_x : 涓績鐐箈鍧愭爣
 * params.center_y : 涓績鐐箉鍧愭爣
 * params.deg : 寮у害,涓烘鍒欓『鏃堕拡鏃嬭浆,涓鸿礋鍒欓€嗘椂閽堟棆杞�
 * @returns
 */
 ...
 * 姣忎竴甯х殑鍔ㄧ敾
 * @param params
 * params.x : 鍒濆浣嶇疆鐨剎鍧愭爣
 * params.y : 鍒濆浣嶇疆鐨剏鍧愭爣
 * params.del : 鍒濆浣嶇疆鐨勬棆杞姬搴�
 * params.zoom : 鍒濆浣嶇疆鐨勭缉鏀惧€嶇巼
 * @param animate_params
 * animate_params.vx : x鏂瑰悜浣嶇Щ
 * animate_params.vy : y鏂瑰悜浣嶇Щ
 * animate_params.pal : 瑙掗€熷害,姝ｄ负椤烘椂閽�
 * animate_params.scale : 缂╂斁閫熷害
 * @returns 杩斿洖涓€甯т箣鍚庣殑缁樺埗鍙傛暟
 */
 ...
 * translate_params.ax : x鏂瑰悜鍔犻€熷害
 * translate_params.ay : y鏂瑰悜鍔犻€熷害
 * translate_params.apal : 瑙掑姞閫熷害
 * translate_params.ascale : 缂╂斁鍔犻€熷害
 * @returns
 */
        ...
        firework.update = function(){//改变每一帧的烟火的状态
            if(status == 1){//烟火点燃引线的时候
                ...
                if(life <= 0){//离爆炸的时间为0 的时候
                    ...
                    inBalst.setLife(3);//持续一帧,视觉上看就是一闪的白光
...
var word = ["王","同","学","生","日","快","乐"];
var word_position = [-250,0,//王 的位置
                 0,0,//同 的位置
                 300,0,//学 的位置
                 -375,250,//生 的位置
                 -125,250,//日 的位置
